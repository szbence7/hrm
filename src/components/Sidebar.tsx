    ...
    <>
      ...
      <div className="fixed top-0 left-0 right-0 h-16 bg-gray-900 dark:bg-gray-950 z-20">
        <div className="h-full flex items-center justify-between">
          <div className={`${isCollapsed ? 'w-20' : 'w-64'} transition-all duration-300 px-6 flex items-center`}>
            <h1 className="text-2xl font-bold text-white whitespace-nowrap">HRM System</h1>
          </div>
      ...
      {/* Sidebar */}
      <aside className={`${isCollapsed ? 'w-20' : 'w-64'} fixed left-0 top-16 bottom-0 bg-gray-900 dark:bg-gray-950 text-white transition-all duration-300`}>
